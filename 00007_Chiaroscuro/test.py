  ...
  def test_has_contrast_black_black_is_false(self):
    self.assertFalse(has_contrast("black","black"))

  def test_has_contrast_beige_pink_is_false(self):
    self.assertFalse(has_contrast("beige","pink"))

  def test_has_contrast_pink_skyblue_is_false(self):
    self.assertFalse(has_contrast("pink","skyblue"))
